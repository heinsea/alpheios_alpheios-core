...
})(global, (__WEBPACK_EXTERNAL_MODULE_alpheios_data_models__, __WEBPACK_EXTERNAL_MODULE_alpheios_l10n__, __WEBPACK_EXTERNAL_MODULE_alpheios_messaging__, __WEBPACK_EXTERNAL_MODULE_papaparse__) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"servers":[{"texts":[],"isDefault":true,"url":"https://tools.alpheios.net/exist/rest/db/xq/treebank-getmorph.xq?f=r_TEXT&w=r_WORD&clientId=r_CLIENT","providerUri":"https://alpheios.net","providerRights":"The Alpheios Treebank data is licenced under the Creative Commons 3.0 Share-Alike license.","allowUnknownValues":true,"featuresArray":[["pofs","part",true],["case","grmCase",false],["num","number",false],["gend","gender",false],["voice","voice",false],["mood","mood",false],["pers","person",false],["comp","comparison",false]]}]}');
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"url":"https://latin.packhum.org/rst/concordance/","sourceTextUrl":"https://latin.packhum.org","rights":"Word usage examples are provided by The Packard Humanities Institute (https://packhum.org/). They are to be used only for personal study and are subject to the “Fair Use” principles of U.S. Copyright law.","maxResultsOverride":10000000}');
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"url":"https://api-v2.logeion.org/search?q=","limit":10,"availableLangs":["lat","grc"]}');
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"fetchOptions":{"baseUrl":"https://tools.alpheios.net/tokenizer/","sourceType":"text"}}');
